...
export const AssessmentForm: React.FC<AssessmentFormModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xl w-full max-w-3xl z-10 relative transform transition-all max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          onClick={onClose}
